  ...
  async authenticate(request: Request): Promise<UserProfile | undefined> {
    ...
    if (token) {
      ...
      try {
        ...
        throw new HttpErrors[401]("No se tiene permiso para ejecutar la accion");
      }
    }
    throw new HttpErrors[401]("No es posible ejecutar la accion por falta de un token de autenticacion");
  }
}
